...
// Filtering Logic
$showonly = isset($_GET["showonly"]) ? $_GET["showonly"] : 'all'; // Default to 'all'

if ($showonly == 'all') {
    $sqlmain = "SELECT * FROM patient ORDER BY pid DESC;";
} else {
    $sqlmain = "SELECT * FROM appointment INNER JOIN patient ON patient.pid=appointment.pid ORDER BY appointment.appodate DESC;";
}
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <table width="83%" class="sub-table scrolldown"  style="border: spacing 1px;">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-centre: 45px;font-size:20px;color:rgb(49, 49, 49)">We  couldnt find anything related to your keywords !</p>
        ...
        $action=$_GET["action"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="73%" class="sub-table scrolldown add-doc-form-container" border="0">
